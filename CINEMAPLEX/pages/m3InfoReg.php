...
<body id="top">
  ...
  <div class="special-dish-banner">
    <img src="./assets/images/now_showing/service-3.jpg" width="940" height="900" loading="lazy" alt="special dish"
      class="img-cover">
  </div>
  ...
  <div class="special-dish-content bg-black-10">
    <div class="container">
      ...
      <h2 class="headline-1 section-title">Spider Man.</h2>
      <p class="section-subtitle2 label-2">2 HR 01 MIN</p>
      <p class="section-subtitle2 label-2">Action, Adventure, Sci-Fi</p>

      

      <p class="section-text">
        Peter Parker, aka Spider-Man, returns to action as he faces a new city-threatening
        villain. Balancing the challenges of being a student and a superhero, he must 
        confront a formidable adversary who endangers his loved ones and the city itself. In 
        this high-flying, web-slinging adventure, Spider-Man relies on his incredible 
        abilities and unwavering determination to protect his city and ensure justice 
        prevails.
      </p>
