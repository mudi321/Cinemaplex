...
<body id="top">
  ...
  <div class="special-dish-banner">
    <img src="./assets/images/now_showing/service-2.jpg" width="940" height="900" loading="lazy" alt="special dish"
      class="img-cover">
  </div>
  ...
  <div class="special-dish-content bg-black-10">
    <div class="container">
      ...
      <h2 class="headline-1 section-title">Jhon Wick.</h2>
      <p class="section-subtitle2 label-2">1 HR 41 MIN</p>
      <p class="section-subtitle2 label-2">Action, Crime, Thriller</p>

      

      <p class="section-text">
        An ex-hitman, John Wick, comes out of retirement to track down the gangsters who
        killed his dog and stole his car, setting off a relentless and action-packed quest 
        for vengeance that will plunge him into the shadowy world of assassins and challenge
        his very survival.
      </p>
