    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="./moviesGuest.php" class="navbar-link hover-underline active">
              <div class="separator"></div>
          ...
          <li class="navbar-item">
            <a href="./aboutUsGuest.html" class="navbar-link hover-underline">
              <div class="separator"></div>
      ...
      <a href="../register_form.php" class="btn btn-secondary">
        <span class="text text-1">Sign In/ Sign Up</span>

        <span class="text text-2" aria-hidden="true">Sign In/ Sign Up</span>
      </a>
      ...
      <section class="hero text-center" aria-label="home" id="home">
        ...
        <ul class="hero-slider" data-hero-slider>
          ...
          <li class="slider-item active" data-hero-slider-item>
            ...
            <a href="./pages/m2InfoGuest.html" class="btn btn-primary slider-reveal">
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <a href="./pages/m12InfoGuest.html" class="btn btn-primary slider-reveal">
              <span class="text text-1">More Info</span>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <a href="./pages/m3InfoGuest.html" class="btn btn-primary slider-reveal">
              <span class="text text-1">More Info</span>
        ...
        <a href="../register_form.php" class="hero-btn has-after">
          <img src="./assets/images/hero-icon.png" width="48" height="48" alt="booking icon">

          <span class="label-2 text-center span">Register Now</span>
        </a>
...
<!-- Movie Poster Slider -->
      <section class="hero2 text-center" aria-label="home" id="home">
        ...
        <a href="./pages/ntReleased.html" class="hero-btn has-after">
        ...
        ?>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="../register_form.php" class="btn-text hover-underline label-2">Sign In  / Sign Up</a>
    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="./moviesGuest.php" class="label-2 footer-link hover-underline">Movies</a>
          </li>

          <li>
            <a href="./aboutUsGuest.html" class="label-2 footer-link hover-underline">About Us</a>
          </li>
